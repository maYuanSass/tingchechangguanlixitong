               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="车辆牌照" prop="cheliangPaizhao">
                       <el-input v-model="ruleForm.cheliangPaizhao"
                                 placeholder="车辆牌照" clearable  :readonly="ro.cheliangPaizhao"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.cheliangFile" label="车牌" prop="cheliangFile">
                        <file-upload
                                tip="点击上传车牌"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.cheliangFile?$base.url+ruleForm.cheliangFile:''"
                                @change="cheliangFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.cheliangFile" label="车牌" prop="cheliangFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.cheliangFile"  >车牌下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.cheliangContent"  label="车辆介绍" prop="cheliangContent">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            cheliangFileUploadChange(fileUrls){
                this.ruleForm.cheliangFile = fileUrls;
                this.addEditUploadStyleChange()
            },
