        ...
        <div v-if="showFlag">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/tingchechangguanlixitong/upload/cheliangMuBan.xls"
                        >批量导入车辆数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('cheliang','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="cheliangFile"
                                     header-align="center"
                                     width="200"
                                     label="车牌">
                        <template slot-scope="scope">
                            <div v-if="scope.row.cheliangFile">
                                <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+scope.row.cheliangFile">下载</a>
                            </div>
                            <div v-else>无文件</div>
                        </template>
                    </el-table-column>
