...
import huanyuan from '@/views/modules/databaseBackup/huanyuan'
    ...
    import weigui from '@/views/modules/weigui/list'
    ...
    import dictionaryWeigui from '@/views/modules/dictionaryWeigui/list'
...
const routes = [{
    ...
    ,{
        path: '/dictionaryWeigui',
        name: '违规类型',
        component: dictionaryWeigui
    }
    ,{
        path: '/config',
        name: '轮播图',
